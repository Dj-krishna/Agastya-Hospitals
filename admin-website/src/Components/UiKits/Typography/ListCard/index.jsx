...
const ListCard = () => {
  ...
  let Fontawesomelist = ['<i className="fa fa-angle-double-right txt-primary me-2"></i>Lorem ipsum dolor sit amet', '<i className="fa fa-angle-double-right txt-primary me-2"></i>Lorem ipsum dolor sit amet', '<i className="fa fa-angle-double-right txt-primary me-2"></i>Lorem ipsum dolor sit amet', '<i className="fa fa-angle-double-right txt-primary me-2"></i>Lorem ipsum dolor sit amet', '<i className="fa fa-angle-double-right txt-primary me-2"></i>Lorem ipsum dolor sit amet', '<i className="fa fa-angle-double-right txt-primary me-2"></i>Lorem ipsum dolor sit amet', '<i className="fa fa-angle-double-right txt-primary me-2"></i>Lorem ipsum dolor sit amet', '<i className="fa fa-angle-double-right txt-primary me-2"></i>Lorem ipsum dolor sit amet'];
  let Iconlist = ['<i className="fa fa-caret-right txt-secondary me-2"></i>Lorem ipsum dolor sit amet', '<i className="fa fa-caret-right txt-secondary me-2"></i>Lorem ipsum dolor sit amet', '<i className="fa fa-caret-right txt-secondary me-2"></i>Lorem ipsum dolor sit amet', '<i className="fa fa-caret-right txt-secondary me-2"></i>Lorem ipsum dolor sit amet', '<i className="fa fa-caret-right txt-secondary me-2"></i>Lorem ipsum dolor sit amet', '<i className="fa fa-caret-right txt-secondary me-2"></i>Lorem ipsum dolor sit amet', '<i className="fa fa-caret-right txt-secondary me-2"></i>Lorem ipsum dolor sit amet', '<i className="fa fa-caret-right txt-secondary me-2"></i>Lorem ipsum dolor sit amet'];
  let Themfylist = ['<i className="icofont icofont-ui-rate-add txt-success me-2"></i>Lorem ipsum dolor sit amet', '<i className="icofont icofont-ui-rate-add txt-success me-2"></i>Lorem ipsum dolor sit amet', '<i className="icofont icofont-ui-rate-add txt-success me-2"></i>Lorem ipsum dolor sit amet', '<i className="icofont icofont-ui-rate-add txt-success me-2"></i>Lorem ipsum dolor sit amet', '<i className="icofont icofont-ui-rate-add txt-success me-2"></i>Lorem ipsum dolor sit amet', '<i className="icofont icofont-ui-rate-add txt-success me-2"></i>Lorem ipsum dolor sit amet', '<i className="icofont icofont-ui-rate-add txt-success me-2"></i>Lorem ipsum dolor sit amet', '<i className="icofont icofont-ui-rate-add txt-success me-2"></i>Lorem ipsum dolor sit amet'];;
