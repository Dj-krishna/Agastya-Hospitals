...
import { EmailAddress, ExampleMultipleSelect, ExampleSelect, ExampleTextarea, Password, RaiseInputStyle } from '../../../../Constant';
import HeaderCard from '../../../Common/Component/HeaderCard';
import FooterCard from '../Common/FooterCard';

const RaiseInputStyleClass = () => {
    return (
        <Fragment>
            <Card>
                <HeaderCard title={RaiseInputStyle} />
...
export default RaiseInputStyleClass;