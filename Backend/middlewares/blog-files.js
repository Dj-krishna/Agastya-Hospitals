...
const blogFilesMiddleware = (req, res, next) => {
  ...
  // Multipart form-data for files (postThumbnail, postBanner)
  const handler = upload.fields([
    { name: 'postThumbnail', maxCount: 1 },
    { name: 'postBanner', maxCount: 1 },
  ]);
...
module.exports = { blogFilesMiddleware };
