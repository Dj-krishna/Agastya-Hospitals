      ...
      <div className="py-2">
        <div className="container flex justify-between items-center top-infonavigation">
          <div className="flex items-center space-x-4">
            <span className="appointment-details"><span>24x7 Appointment Helpline - </span> 040 65 108 108, &nbsp; +91 9459 108 108</span>
          </div>
          <div className="flex items-center space-x-4">
            <Link to="/patient" className="patientlogin">
              Patient Login
            </Link>
            <button className="bookappointment">
        ...
        <div className="flex justify-between items-center">
          ...
          <div className="flex items-center">
            <div className="text-2xl font-bold text-hospital-blue">
              <img src={'https://res.cloudinary.com/sdk28cdn/image/upload/v1756301086/agastya/agastyahospitals-logo.svg'} alt="Agastya Hospitals" />
            </div>
          </div>
          {/* Left Navigation */}
