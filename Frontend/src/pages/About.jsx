      ...
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-4xl mx-auto aboutus-text">
          <div className="bg-white p-8">
            <p>
              Agastya Hospitals, is a 150 bedded hospital located on converge of
              5 most important routes of twin cities, situated at Omakar Nagar,
              Nagarjuna Sagar Road, L B Nagar, Hyderabad. The project was
              conceived by 4 of the most enterprising Medical Professionals of
              the City.
            </p>
            <p>
              Agastya Hospitals is a Premier multi-specialty tertiary care
              hospital, offering expertise and experience in multiple super
              specialties of the medical field. It is established with a vision
              of emerging as a Hospital of first choice to the patients not only
              from Hyderabad but also from beyond the boundaries of State and
              the Nation. From pursuit of this vision emanates a passion to
              excel.
            </p>
          </div>
        </div>
          ...
          <div class="second-opinion-section">
            <div class="second-opinion-content">
              ...
              <p class="mt-3">
                ...
                about your health can be challenging. Whether you’re facing a
                new diagnosis, considering treatment options, or just need
                reassurance about your current care plan, we’re here to help.
                Our experienced team of specialists offers comprehensive
                evaluations to ensure you feel confident in your healthcare
                choices.
              </p>
