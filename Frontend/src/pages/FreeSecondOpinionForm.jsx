    ...
    <div className="container py-8 max-w-xl mx-auto">
      ...
      {submitted ? (
        <div className="bg-green-100 text-green-700 p-4 rounded mb-4">
          Thank you for submitting your request! Our team will contact you soon.
        </div>
      ) : (
        <form onSubmit={handleSubmit} className="space-y-5 bg-white p-6 rounded shadow">
          ...
          <div>
            <label className="block font-medium mb-1" htmlFor="message">Describe Your Case</label>
            <textarea
              className="w-full border border-gray-300 rounded px-3 py-2"
              id="message"
              name="message"
          ...
          <div>
            <label className="block font-medium mb-1" htmlFor="reports">Upload Medical Reports (optional)</label>
            <input
              className="w-full"
              type="file"
              id="reports"
